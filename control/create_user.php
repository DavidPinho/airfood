...
if(empty($_POST['password'])||$_POST['password']==''){
	...
	$list_erro_return[$erro_count+1]="confirmPassword;Type six or more characters";
	$erro_count+=2;
}else if($_POST['password']!=$_POST['confirmPassword']){
	$list_erro_return[$erro_count]="password; Wrong Password.";
	$list_erro_return[$erro_count+1]="confirmPassword; Wrong Password.";
	$erro_count+=2;
}
